class PowerdashboardforStrydplusApp extends Toybox.Application.AppBase {
...
class DatarunView extends Toybox.WatchUi.DataField {
	...
	//! 0     => no averaging of current power
	//! 1     => 3 sec averaging of current power
	//! 2     => 5 sec averaging of current power
	//! 3     => 10 sec averaging of current power
    ...
    //! Lower fields enum:
    //! 0 => (overall) Average power
    //! 1 => Last lap power 
    //! 2 => Average efficiency Index
    //! 3 => Current lap efficiency Index    
    //! 4 => Last lap efficiency Index
    //! 5 => Average efficiency factor
    //! 6 => Current lap efficiency factor 
    //! 7 => Last lap efficiency factor
...
//! Draw separator lines
		...
		var Garminfont2;
	    var Garminfont3;
		if (watchType.equals("006-B2544-00") == true or watchType.equals("006-B2432-00") == true) {
 	    	Garminfont2 = Ui.loadResource(Rez.Fonts.Garmin2);
	    	Garminfont3 = Ui.loadResource(Rez.Fonts.Garmin3);
		} else {
 	    	Garminfont2 = Graphics.FONT_NUMBER_MEDIUM;
...
//!===============================Device specific code hereabove==============================================================		
        ...
        if (uBottomRightMetric == 0) {
            ...
            fieldLabel = "AEI 5s";
            fieldformat = "2decimal";
        } else if (uBottomRightMetric == 13) {
            fieldValue = AEIndex10;
            fieldLabel = "AEI 10s";
            fieldformat = "2decimal";
		}  else if (uBottomRightMetric == 14) {
            fieldValue = AEIndex20;
            fieldLabel = "AEI 20s";
            fieldformat = "2decimal";
        } else if (uBottomRightMetric == 15) {
            fieldValue = AEIndex30;
            fieldLabel = "AEI 30s";
            fieldformat = "2decimal";
		}
